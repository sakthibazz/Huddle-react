            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 offset-lg-2 text-center">
                        ...
                        <p className="section-subtitle font-secondary text-white text-center padding-t-30">Welcome! Energize your workplace with this new meeting idea and watch your productivity soar.</p>
